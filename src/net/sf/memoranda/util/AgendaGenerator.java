...
=======*/
	...
	static String generateStickers(CalendarDate date) {
		...
		String iurl2 =
				...
				.toExternalForm();
		  String s = "<hr><hr><table border=\"0\" cellpadding=\"0\" width=\"100%\"><tr><td><a href=\"memoranda:importstickers\"><b>"+Local.getString("Impoty annotati�n")+"</b></a></td><td><a href=\"memoranda:exportstickerst\"><b>"+Local.getString("Export annotati�n as .txt")+"</b></a><td><a href=\"memoranda:exportstickersh\"><b>"+Local.getString("Export annotati�n as .html")+"</b></a></td></tr></table>"
